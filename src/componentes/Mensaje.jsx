...
const Mensaje = ( {mensaje} ) => {
    ...
    return (
        <div className={`${ auth._id === mensaje.emisor ? 'justify-end' : 'justify-start'} flex  gap-3`}>
            ...
            <img className={`${ auth._id === mensaje.emisor ? 'block' : 'hidden'}w-6 h-6 rounded-full bg-color4`} src={`${import.meta.env.VITE_BACKEND_URL}/public/${chatActivo.profilePicture}`} alt="" />

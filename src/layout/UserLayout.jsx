    ...
    return( 
        <>
            <div className="flex flex-col-reverse h-screen lg:flex-row">
                <nav className={`${openChat ? 'hidden' : 'block'} lg:flex flex justify-evenly p-3 border-t-2 border-color4 lg:flex-col lg:justify-start lg:gap-5 lg:border-r-2 lg:border-t-0`}>
                    <Link to={'/user/inbox'} >
